...
export default function PillButton({
  ...
  const classes = `group inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-sm font-semibold shadow-sm transition hover:-translate-y-0.5 hover:shadow-md ${TONE_VARIANTS[tone][variant]} ${className}`;
